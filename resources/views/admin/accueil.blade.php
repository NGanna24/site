                                 ...
                                 <div class="row">
                                    <div class="col-6">
                                       <div class="avatar-md bg-soft-primary rounded">
                                          <iconify-icon class="avatar-title fs-32 text-primary" icon="solar:cart-5-bold-duotone"></iconify-icon>
                                       </div>
                                    </div>
                                    <!-- end col -->
                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="text-center">
                              <button class="btn btn-light shadow-none w-100" type="button">View Details</button>
                           </div>
                           <!-- end row -->
                        </div>
                     </div>
                  ...
                  <div class="col-lg-4">
                     <div class="card card-height-100">
                        <div class="card-header d-flex align-items-center justify-content-between gap-2">
                           ...
                           <a class="btn btn-sm btn-soft-primary" href="#">View All</a>
                        </div>
                        <div class="table-responsive">
                           <table class="table table-hover table-nowrap table-centered m-0">
                              ...
                              <tbody>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/ecommerce.html</a></td>
                                    <td>465 </td>
                                    <td><span class="badge badge-soft-success">4.4%</span></td>
                                 </tr>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/dashboard.html</a></td>
                                    <td> 426</td>
                                    <td><span class="badge badge-soft-danger">20.4%</span></td>
                                 </tr>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/chat.html</a></td>
                                    <td>254 </td>
                                    <td><span class="badge badge-soft-warning">12.25%</span></td>
                                 </tr>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/auth-login.html</a></td>
                                    <td> 3369</td>
                                    <td><span class="badge badge-soft-success">5.2%</span></td>
                                 </tr>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/email.html</a></td>
                                    <td>985 </td>
                                    <td><span class="badge badge-soft-danger">64.2%</span></td>
                                 </tr>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/social.html</a></td>
                                    <td>653 </td>
                                    <td><span class="badge badge-soft-success">2.4%</span></td>
                                 </tr>
                                 <tr>
                                    <td class="ps-3"><a class="text-muted" href="#">larkon/blog.html</a></td>
                                    <td>478 </td>
                           ...
                           <table class="table mb-0">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td>29 April 2024</td>
                                    <td>
                                       <img alt="product-1(1)" class="img-fluid avatar-sm" src="assets/images/product-1(1).png"/>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                       <img alt="product-4" class="img-fluid avatar-sm" src="assets/images/product-4.png"/>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                       <img alt="product-5" class="img-fluid avatar-sm" src="assets/images/product-5.png"/>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    ...
                                    <td>21 April 2024</td>
                                    <td>
                                       <img alt="product-6" class="img-fluid avatar-sm" src="assets/images/product-6.png"/>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    ...
                                    <td>18 April 2024</td>
                                    <td>
                                       <img alt="product-1(2)" class="img-fluid avatar-sm" src="assets/images/product-1(2).png"/>
                                    </td>
                                    <td>
                           ...
                           <div class="row g-3">
                              ...
                              <div class="col-sm-auto">
                                 <ul class="pagination m-0">
                                    <li class="page-item">
                                       <a class="page-link" href="#"><i class="bx bx-left-arrow-alt"></i></a>
                                    </li>
                                    ...
                                    <li class="page-item">
                                       <a class="page-link" href="#"><i class="bx bx-right-arrow-alt"></i></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Custom by 
                        <iconify-icon class="fs-18 align-middle text-danger" icon="iconamoon:heart-duotone"></iconify-icon>
                        <a class="fw-bold footer-text" href="https://www.admintem.com/" target="_blank">StarCode Kh</a>
                     </div>
                  </div>
               </div>
            </footer>
